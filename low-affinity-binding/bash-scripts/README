...
Files are organized in a manner as such-
  ...
  cpptraj_run.sh
   ...
   run_curves+.sh
     ...
     Shell script to assist in running curves+ and processing the data into easily interpetable forms. There are some specific options in the input, so please read the comments carefully.
